...
<div class="archive-header text-center mt-40">
    <div class="container">
        <h2><span class="color3">Images</span></h2>
                ...
                <div class="loop-grid row">
                    ...
                    <article class="col-lg-6 mb-50 animate-conner">
                        <div class="post-thumb d-flex mb-30 border-radius-5 img-hover-scale animate-conner-box">
                            <a href="{{ route('images-detail', $item->slug) }}">
                                <img src="{{ Storage::url($item->galleries->first()->photos) }}" alt="">
                            </a>
                            <span class="top-right-icon background7"><i class="mdi mdi-camera-alt"></i></span>
                        </div>
                        <div class="post-content">
                            ...
                            <h3 class="post-title">
                                <a href="{{ route('images-detail', $item->slug) }}">{{ $item->post_title; }}</a>
                            </h3>
                            <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                                <span class="post-by">By <a href="{{ route('author', $item->user->id) }}">{{ $item->user->name; }}</a></span>
