    ...
    <div class="home-featured">
        <div class="post-carausel-3 post-module-1">
            ...
            @foreach ($headlines as $headline)
                <?php if (empty($headline->post)) {
                    continue;
                }
                ?>
                <div class="post-thumb position-relative">
                    <div class="thumb-overlay img-hover-slide position-relative"
                        style="background-image: url({{ Storage::url($headline->post->post_image) }})">
                                    ...
                                    <div class="single-wrap d-flex justify-content-center">
                                        @if ($post->hasPages())
                                            <ul class="pagination" role="navigation">
                                                ...
                                                @for ($i = $start; $i <= $end; $i++)
                                                    <li
                                                        class="page-item {{ $post->currentPage() == $i ? ' active' : '' }}">
                                                        <a class="page-link"
                                                            href="{{ $post->url($i) }}">{{ $i }}</a>
                                                    </li>
                                                @endfor
                                                @if ($end < $post->lastPage())
                                                    ...
                                                    <li class="page-item">
                                                        <a class="page-link"
                                                            href="{{ $post->url($post->lastPage()) }}">{{ $post->lastPage() }}</a>
                                                    </li>
                                                @endif
                                                ...
                                                @if ($post->hasMorePages())
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ $post->nextPageUrl() }}"
                                ...
                                <nav class="tab-nav float-none mb-20">
                                    <div class="nav nav-tabs" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-popular-tab" data-toggle="tab"
                                            ...
                                            aria-selected="true">Teknologi</a>
                                    </div>
                                </nav>
                            ...
                            <div class="post-thumb position-relative">
                                <div class="thumb-overlay img-hover-slide border-radius-5 position-relative"
                                    ...
                                    <div class="post-content-overlay">
                                        ...
                                        <h6 class="post-title">
                                            <a class="color-white"
                                                href="{{ route('post-detail', $item->slug) }}">{{ $item->post_title }}</a>
                                        </h6>
                                        <div class="entry-meta meta-1 font-small color-grey mt-10 pr-5 pl-5">
                                            <span class="time-reading">
                                                <i class="ti-user"></i>{{ splitName($item->user->name) }}
