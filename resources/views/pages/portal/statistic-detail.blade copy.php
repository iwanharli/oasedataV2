                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-chart-tab" data-toggle="pill"
                                    data-target="#pills-chart" type="button" role="tab" aria-controls="pills-chart"
                                    aria-selected="true">Chart</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-table-tab" data-toggle="pill"
                                    data-target="#pills-table" type="button" role="tab" aria-controls="pills-table"
                    ...
                    <div class="author-bio">
                        <div class="author-image mb-30">
                            ...
                            @else
                                <a href="#">
                                    <img src="https://ui-avatars.com/api/?name={{ $post->user->name }}" alt=""
                                        class="avatar">
                                </a>
                            @endif
                        </div>
                        <div class="author-info">
                            ...
                            <div class="author-description">Penulis di {{ $app->name }} Sejak
                                {{ date('d F Y', strtotime($post->user->created_at)) }}</div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="post-thumb position-relative thumb-overlay">
                                            <div class="img-hover-slide border-radius-5 position-relative"
                                                style="background-image: url({{ Storage::url($item->post_image) }}">
